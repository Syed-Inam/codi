            ...
            //    }
                ...
                for (var i = 0; i < radio.length; i++) {
                    if (radio[1].checked) {
                        ...
                        document.getElementById("row16").style.display = 'table-row';
                    }
            ...
            <asp:Panel ID="formPanel" runat="server" Visible="true">
                ...
                <table  style="text-align: left; width: 100%; margin-top: 20px;margin:auto; font-size: small; background-color: #EDEDED; font-family: Tahoma; width:90%">
                    ...
                    <tr class="thStyle" id="row11">
                        ...
                        <td colspan="3" class="tdStyle tdText">
                            <asp:RadioButtonList runat="server" ID="Q11" RepeatDirection="Horizontal" ClientIDMode="Static">
                                <asp:ListItem Value="1" Text="YES&emsp;&emsp;"></asp:ListItem>
                                <asp:ListItem Value="2" Text="NO"></asp:ListItem>
                            </asp:RadioButtonList>
                ...
                <br />
                <br />
                <asp:Button ID="s01next" class="btn-primary btn-lg btn" OnClick="btnSubmit_Click" Style="width: 100px" runat="server" Text="Submit" BackColor="#2574A9"  />
