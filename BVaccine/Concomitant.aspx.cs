...
namespace BVaccine
{
    public partial class Concomitant : System.Web.UI.Page
    {
        ...
        public bool FormExist()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select * from medication where cmsid='" + cmsid.Text + "' ", con);
            con.Open();
            try
            {
        ...
        public void insertdata()
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("insert into medication(cmss,cmsid, cmsr1_a, cmsr1_b, cmsr1_cd, cmsr1_d, cmsr1_e, cmsr1_f, cmsr1_g, cmsr1_h, cmsr2_a, cmsr2_b, cmsr2_cd, cmsr2_d, cmsr2_e, cmsr2_f, cmsr2_g, cmsr2_h," +
                    " cmsr3_a, cmsr3_b, cmsr3_cd, cmsr3_d, cmsr3_e, cmsr3_f, cmsr3_g, cmsr3_h, cmsr4_a, cmsr4_b, cmsr4_cd, cmsr4_d, cmsr4_e, cmsr4_f, cmsr4_g, cmsr4_h, cmsr5_a, cmsr5_b, cmsr5_cd, cmsr5_d, cmsr5_e, cmsr5_f, cmsr5_g, cmsr5_h, cmcoinv_cd,cmcoinv_dt, cms_sup_cd, cms_sup_dt, user, date_enter) " +
                    ...
                    " '" + cmsr5_a.Text + "', '" + cmsr5_b.Text + "', '" + cmsr5_c.Text + "', '" + cmsr5_d.Text + "', '" + cmsr5_e.Text + "', '" + cmsr5_f.Text + "', '" + cmsr5_g.Text + "', '" + cmsr5_h.Text + "', " +
                    " '" + inv_nm.Text + "','" + inv_dt.Text + "','" + sup_nm.Text + "','" + sup_dt.Text + "','" + Convert.ToString(Session["User"]) + "', '" + DateTime.Now.ToString("dd-MM-yyyy hh:mm tt") + "')", con);
                cmd.ExecuteNonQuery();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else if (cmsr1_a.Text == "")
            {
                showalert("Enter atleast one medication!");
                cmsr1_a.Focus();
            }
